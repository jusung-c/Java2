...
import elementFind.receiver.SymbolFinder;
...
public class SymbolFinderCommand extends FinderCommand {
    ...
    public List<PeriodicElement> execute(List<PeriodicElement> elements) throws IOException {
        ...
        // String 배열을 입력받아 SymbolFinder 생성
        System.out.print("조회하고 싶은 원소의 기호를 공백(' ')을 기준으로 입력하세요. (ex. H, O, ...): ");
        finder = new SymbolFinder(UserInput.getStringArray());

        // 주어진 원소 리스트 (elements)에서 SymbolFinder 이용해 조회 후 리턴
